...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'Regular',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'Regular',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#000',
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'Regular' : 'Regular',
  titleFontSize: platform === PLATFORM.IOS ? 17 : 19,
  subTitleFontSize: platform === PLATFORM.IOS ? 11 : 14,
  subtitleColor: platform === PLATFORM.IOS ? '#000' : '#000',
